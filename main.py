...
d = 43+25+43+60+43+78
e = 120
f = 63+45+129+63+58+48+63
sum0 = a+b+c+d+e+f
sum = 632+562+335+600+855+500
sum1 = 10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78
sum2 = round(253.6*10+86.3*60+96.8*43+135.9*63+65.8*63+49.3*120+86.3*72+253.6*69+
                86.3*35+253.6*140+86.3*90+135.9*24+65.8*45+96.8*25+86.3*60+65.8*129+253.6*10+
                96.8*43+65.8*63+86.3*60+135.9*63+96.8*60+65.8*58+86.3*140+65.8*48+96.8*43+
                135.9*57+253.6*10+65.8*63+96.8*78,2)
print("总销售额：￥",sum2)
print("每件衣服的销售占比:","%.2f" % (sum0 / sum * 100) + '%')
print("每件衣服的销售额占比:","%.2f" % (sum0 / sum2 * 100) + '%')
